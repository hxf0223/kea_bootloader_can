...
#define LOCAL_OUTPUT_SET(port,register_num)						XOUTPUT_SET(port,register_num)
#define XOUTPUT_SET(port,register_num)							(GPIO##port##_PSOR |=1<<register_num)

#define LOCAL_OUTPUT_CLEAR(port,register_num)					XOUTPUT_CLEAR(port,register_num)
#define XOUTPUT_CLEAR(port,register_num)						(GPIO##port##_PCOR |=1<<register_num)

#define LOCAL_OUTPUT_TOGGLE(port,register_num)					XOUTPUT_TOGGLE(port,register_num)
#define XOUTPUT_TOGGLE(port,register_num)						(GPIO##port##_PTOR |=1<<register_num)

#define LOCAL_INPUT_DATA(port,register_num)						XINPUT_DATA(port,register_num)
#define XINPUT_DATA(port,register_num)							((GPIO##port##_PDIR >> register_num) & 0x00000001)
...
//------------------CAN--input------------------------------------------
#define I_D_ACAN_INT	LOCAL_INPUT_DATA(PORT_E,5)
#define I_D_DCAN_INT	LOCAL_INPUT_DATA(PORT_E,6)
...
#define DEV_2515_ERROR_RECV_LENTH	0XFC
...
#define I_D_DCAN_INT	LOCAL_INPUT_DATA(PORT_E,6)
//--------------------output------------------------------------------
#define O_D_ACAN_Silent_EN(X)	LOCAL_OUTPUT_DATA(PORT_D,28,X)
#define O_D_DCAN_Silent_EN(X)	LOCAL_OUTPUT_DATA(PORT_D,29,X)
#define O_D_ACAN_CS(X)			LOCAL_OUTPUT_DATA(PORT_E,3,X)
#define O_D_DCAN_CS(X)			LOCAL_OUTPUT_DATA(PORT_E,4,X)	*/
...
// RXBnSIDL 0X61 0X62
#define RXB0SIDL_SRR_1	0X10
#define RXB0SIDL_SRR_0	0X10
#define RXB0SIDL_IDE_1	0X04
...
extern byte dev_2515_recv_register(byte channel,byte address,byte *data);
extern void dev_2515_reset(byte channel,byte cmd);
extern void dev_2515_delay(unsigned int x);
